    ...
    <form action="customer" method="post">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="exampleInputEmail1" name="quantity">
                     <div id="emailHelp" class="form-text">Enter the coffee quantity....</div>
                      </div>
                       <div class="mb-3">
                              Enter the Payment Mode:
                              <div class="form-check">
                               <input class="form-check-input" type="radio" name="payment" value="cash" id="radioDefault1">
                                <label class="form-check-label" for="radioDefault1">
                                Cash On Delivery
                                </label>
                                </div>
                               <div class="form-check">
                                <input class="form-check-input" type="radio" name="payment" value="online" id="radioDefault2" checked>
                              <label class="form-check-label" for="radioDefault2">
                                    Online payment
                                 </label>
                             </div>
