...
public class HospitalDelete {
    public static void main(String[] args) {
        ...
        try {
            ...
            String query1="Delete from hospital where hospital_id=17";
            String query2="Delete from hospital where hospital_id=74";
            String query3="Delete from hospital where hospital_id=63";
