...
public class StreetDelete {
    public static void main(String[] args) {
        ...
        try {
            ...
            String query1="Delete from street where street_id=7";
            String query2="Delete from street where street_id=69";
            String query3="Delete from street where street_id=33";
